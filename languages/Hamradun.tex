...
\hspace{0.9cm}Í dreyminum á nátt, tá mítt hjarta ókyrt slær, \tab{F C G a}\\
\hspace{0.9cm}ver tú í logn við mær...\tab{}\tab{}\tab{F G a}\\
\hops
...
\hops
\hspace{0.9cm}\sng{Niðurlag}\\ 
\hspace{0.9cm}Vel op før Dag, \tab{}\tab{d A}\\
\hspace{0.9cm}de kommer vel over den Hede.\tab{g A d}\\
\hops
