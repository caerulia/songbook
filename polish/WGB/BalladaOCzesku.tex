...
A kromkę masłem smarując każdy \tab{G A}\\
Mówił: Nad chleby ten chleb od Cześka. \tab{D A D}\\
\hops
Ref. Chleb się chlebie, chleb się chlebie \tab{C G e a}\\
\refr Bo nad chleb być może co \tab{C h e}\\
\refr Chleb się chlebie, chleb się chlebie \tab{C G e a}\\
\refr Niech ci nigdy nie zabraknie \tab{C}\\
\refr Drożdży, wody, rąk i ziarna \tab{D A e h}\\
\refr (mruczał Czesiek tak noc w noc) \tab{GD A G D}\\
\hops
